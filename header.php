...
<div id="page" class="hfeed site">
  ...
  (function($){
    $(document).ready( function(){
      // var content = $('#content');
      // $(content).wrapInner('<div id="inner_content" />');
      $('#menu-mainmenu li ul.sub-menu').parent().addClass('hasSubmenu');
      // $('#menu-mainmenu li ul.sub-menu').parent().addClass('sf-js-enabled');
      $('#menu-mainmenu').superfish();
    })
  })(jQuery);
  </script>
